      ...
      <div
        ...
        <div className="flex flex-col items-center">
          ...
          >
            ...
            <polygon points="57,90 73,57 89,90" stroke="#C8A96E" strokeWidth="2.8" fill="none" strokeLinejoin="round"/>
            {/* ── Crown: center tall triangle with dot ── */}
            <polygon points="76,90 100,36 124,90" stroke="#C8A96E" strokeWidth="2.8" fill="none" strokeLinejoin="round"/>
            <circle cx="100" cy="66" r="6.5" stroke="#C8A96E" strokeWidth="2.8" fill="none"/>
            {/* ── Crown: right small triangle ── */}
            <polygon points="111,90 127,57 143,90" stroke="#C8A96E" strokeWidth="2.8" fill="none" strokeLinejoin="round"/>

            {/* ── Crown base horizontal bar ── */}
            <line x1="44" y1="90" x2="156" y2="90" stroke="#C8A96E" strokeWidth="2.8" strokeLinecap="round"/>

            {/* ── Face left bracket: outer vertical → step inward ── */}
            <polyline points="44,90 44,108 62,108 62,168" stroke="#C8A96E" strokeWidth="2.8" fill="none" strokeLinejoin="round" strokeLinecap="round"/>
            {/* ── Face right bracket: outer vertical → step inward ── */}
            <polyline points="156,90 156,108 138,108 138,168" stroke="#C8A96E" strokeWidth="2.8" fill="none" strokeLinejoin="round" strokeLinecap="round"/>

            {/* ── Upper face: inverted triangle (crown diamond tip) ── */}
            <polygon points="84,90 100,116 116,90" stroke="#C8A96E" strokeWidth="2.8" fill="none" strokeLinejoin="round"/>

            {/* ── Mid-face horizontal bar ── */}
            <line x1="62" y1="116" x2="138" y2="116" stroke="#C8A96E" strokeWidth="2.8" strokeLinecap="round"/>
            ...
            {/* ── Nose: rounded arch ── */}
            <path d="M91,132 Q100,152 109,132" stroke="#C8A96E" strokeWidth="2.8" fill="none" strokeLinecap="round"/>

            {/* ── Mouth / bottom face bar ── */}
            <line x1="62" y1="162" x2="138" y2="162" stroke="#C8A96E" strokeWidth="2.8" strokeLinecap="round"/>

            {/* ── Chin: downward triangle ── */}
            <polygon points="82,168 100,204 118,168" stroke="#C8A96E" strokeWidth="2.8" fill="none" strokeLinejoin="round"/>
