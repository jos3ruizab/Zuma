...
const ProducerDashboardInteractive = () => {
  ...
  const metrics = {
    ...
    earningsVES: mockOffers.filter((o) => o.status === 'sold').reduce((sum, o) => sum + o.priceVES, 0),
    earningsUSD: mockOffers.filter((o) => o.status === 'sold').reduce((sum, o) => sum + o.priceUSD, 0)
  };
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-8">
        ...
        <>
          ...
          <EmptyState type={filters.cropType.length > 0 || filters.status.length > 0 ? 'filtered' : 'active'} />
          }
          </>
        }
